package com.aebiz.common.pay.alipay;
...
public class AliPayController {
	...
	public void alipay_notify(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			signVerified = AlipaySignature.rsaCheckV1(params,  AliPayConfig.alipayPublicKey, AliPayConfig.CHARSET, AliPayConfig.SIGN_TYPE);
