package com.aebiz.common.pay.alipay.service.impl;
...
import com.aebiz.common.pay.alipay.config.AliPayConfig;
import com.aebiz.common.pay.alipay.service.IAliPayService;
...
/*        AlipayTradeRefundRequestBuilder builder = new AlipayTradeRefundRequestBuilder()
 ...
 /*       AlipayF2FRefundResult result = AliPayConfig.getAlipayTradeService().tradeRefund(builder);
	...
	public String aliPayMobile(Product product) {
        ...
        //bizContent.put("seller_id", Configs.getPid());//实际收款账号，一般填写商户PID即可 TODO
	...
	public String aliPayPc(Product product) {
        ...
        bizContent.put("subject","宏碁(Acer)暗影骑士3英特尔酷睿i5游戏本");//订单标题
       // bizContent.put("seller_id", "2019060365452262");//实际收款账号，一般填写商户PID即可
	...
	public boolean rsaCheckV1(Map<String, String> params) {
	    ...
	    try {
			signVerified = AlipaySignature.rsaCheckV1(params,AliPayConfig.alipayPublicKey, "UTF-8");
		} catch (AlipayApiException e) {
			e.printStackTrace();
		}
		return signVerified;
	...
	public boolean rsaCheckV2(Map<String, String> params) {
		...
		boolean signVerified = false;
	    try {
			signVerified = AlipaySignature.rsaCheckV2(params, AliPayConfig.alipayPublicKey, "UTF-8");
		} catch (AlipayApiException e) {
			e.printStackTrace();
		}
		return signVerified;
