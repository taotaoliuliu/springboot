 ...
 ***************************************************************************************
 */
package com.aebiz.common.im.connertor.impl;
...
import com.aebiz.common.im.connertor.ImConnertor;
...
public class ImConnertorImpl implements ImConnertor{
	...
	public void pushMessage(String sessionId,MessageWrapper wrapper) throws RuntimeException{
	   ...
	   try {
	    	///取得接收人 给接收人写入消息
	    	Session responseSession = sessionManager.getSession(wrapper.getReSessionId());  //这个是接受人的 sessionid
    ...
    public void connect(ChannelHandlerContext ctx, MessageWrapper wrapper) {
        try {
        	...
        	System.out.println("ccccccccccccc");
        	  String sessionId = wrapper.getSessionId();  // 这个是登录用户的id
