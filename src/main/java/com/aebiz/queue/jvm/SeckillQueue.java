...
public class SeckillQueue {
    ...
    static BlockingQueue<Ad> blockingQueue = new LinkedBlockingQueue<Ad>(QUEUE_MAX_SIZE);
     ...
     */
    public  Boolean  produce(Ad kill) throws InterruptedException {
    	return blockingQueue.offer(kill);
    }
    //消费出队
    public  Ad consume() throws InterruptedException {
